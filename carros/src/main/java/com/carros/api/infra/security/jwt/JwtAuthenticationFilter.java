...
//Classe que controla o login do endPoint (/api/v1/login)
//Recebe o Json com usuário e senha e retorna o UserDTO
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager) {
    	...
    	this.authenticationManager = authenticationManager;  //Do Spring
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        User user = (User) authentication.getPrincipal();  //É o UserDetails
