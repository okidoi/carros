...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  //Removemos o metodo configure abaixo para passarmos a utilizar o JWT
    @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS);  //desabilita cookies da sessão
    }
